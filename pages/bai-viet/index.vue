      ...
      <div class="container mx-auto px-4">
        <div class="text-center">
          ...
          <p class="text-xl text-gray-300 max-w-2xl mx-auto">
            Cập nhật những thông tin mới nhất về thể hình, dinh dưỡng và các sự
            kiện tại AlphaGym
          </p>
        </div>
      </div>
        ...
        <div class="lg:col-span-3">
          ...
          >
            <div
              v-for="n in 6"
              :key="n"
              class="bg-gray-900 rounded-lg overflow-hidden animate-pulse"
            >
          ...
          <div v-else-if="articlesError" class="text-center py-12">
            ...
            <p class="text-gray-400">
              {{ articlesError.message || "Không thể tải bài viết" }}
            </p>
            <button
            ...
            >
              <div class="relative">
                ...
                <div class="absolute top-4 right-4">
                  <span
                    class="bg-black bg-opacity-70 text-white px-2 py-1 rounded text-xs"
                  >
              ...
              <div class="p-6">
                ...
                <h2
                  class="text-xl font-bold mb-3 group-hover:text-red-500 transition-colors line-clamp-2"
                >
                  {{ article.title }}
                </h2>
                ...
                <div
                  class="inline-flex items-center text-red-500 hover:text-red-400 font-semibold"
                >
                  Đọc thêm
                  <svg
                    class="w-4 h-4 ml-2"
...
} = await useFetch(`${config.public.apiBase}/articles`);

const {
  data: categoriesResponse,
  pending: categoriesLoading,
  error: categoriesError,
} = await useFetch(`${config.public.apiBase}/article-categories`);
...
const filterByCategory = (categorySlug) => {
  selectedCategory.value =
    selectedCategory.value === categorySlug ? "" : categorySlug;
  currentPage.value = 1;
};
